...
const CONTACT_EMAIL = import.meta.env.VITE_CONTACT_EMAIL || "support@herblens.ai";
...
function ContactContent({ onClose }) {
  ...
  const handleSubmit = (e) => {
    ...
    setErrors({});
    const subject = encodeURIComponent(`HerbLens AI contact from ${formData.name}`);
      ...
      {success ? (
        <div className="text-center py-8 sm:py-12">
          ...
          <p className="text-slate-600">
            Please send the draft from your email app.
          </p>
        </div>
      ) : (
